...
//    }
    ...
    public List<PlanoDeDesenvolvimento> consultaTodosPorGestor(Integer codigoGestor) throws SQLException, ClassNotFoundException, IOException {
        conecta();
    ...
    public Gestor consultaPorCodigo(int codigo) throws SQLException, ClassNotFoundException, IOException {
        conecta();
        ...
        rs.next();
        if (rs != null) {
            gestor.setId(rs.getInt("cd_cadastro_associado"));
            ...
            gestor.setCpf(rs.getString("nr_cpf"));
